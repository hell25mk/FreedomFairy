...
void GameUI::Draw(){
	...
	DrawFormatString(vec2.GetDx() + 10, vec2.GetDy() + 10, Color_Red, "HiScore %09d", ScoreManager::GetInstance().GetScore(eScore_High));
	DrawFormatString(vec2.GetDx() + 10, vec2.GetDy() + 40, Color_Red, "  Score %09d", ScoreManager::GetInstance().GetScore(eScore_Now));
